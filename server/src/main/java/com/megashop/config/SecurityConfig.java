package com.megashop.config;

import com.megashop.filter.JwtRequestFilter;
import com.megashop.service.CustomUserDetailsService;
...
public class SecurityConfig {
    ...
    // Use your CustomUserDetailsService
    @Bean
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/users/changePassword").authenticated()
